...
class STA_LSTM(nn.Module):
    def __init__(self, feature_num,feature_num_append,sa_hidden, ta_hidden, output_size, length,temp_node):
        ...
        self.SA = SpatialLSTM(input_dim=(feature_num-feature_num_append), hidden_dim=sa_hidden)
        ...
        self.TA = TemporalLSTM(input_dim=sa_hidden, hidden_dim=ta_hidden, former_seq_len=length, output_dim=output_size, temp_node=temp_node)
