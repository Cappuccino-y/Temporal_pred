...
Plotdata=[data_arima_pred, data_lstm_pred, data1_pred, data_LSTNet_pred, data_Autoformer_pred, data2_pred,data3_pred,data3_optimal_pred]
Plotname=['ARIMA','LSTM','TA-LSTM','LSTNet','Autoformer','TSE-TSD','TSE-TSTD','CTSE-TSTD']
